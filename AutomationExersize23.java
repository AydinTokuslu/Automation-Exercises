...
public class AutomationExersize23 extends TestBase {
    @Test
    public void test() {
        //1. Launch browser
        ...
        Assert.assertTrue(driver.findElement(By.xpath("//ul[@class='address item box']")).getText().contains("techpro"));
        //13. Verify that the billing address is same address filled at the time registration of account
        Assert.assertTrue(driver.findElement(By.xpath("//ul[@class='address item box']")).getText().contains("00905664544788"));
